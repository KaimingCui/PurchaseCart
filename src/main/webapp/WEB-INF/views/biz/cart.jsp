...
<html>
    ...
    <body>
        ...
        <!-- goods区域 -->
        <form action="${pageContext.request.contextPath}/cart/settlement.do" id="cartBody">
                ...
                <div class="bd">
                    ...
                    <c:forEach items="${carts}" var="cart">
                        <ul class="order-list">
                            ...
                            <li class="number">
                                <div class="input-num">
                                    <a href="${pageContext.request.contextPath}/cart/decr.do?productId=${cart.productId}">-</a>
                                    <input type="text" value="${cart.count}" class="num">
                                    <a href="${pageContext.request.contextPath}/cart/incr.do?productId=${cart.productId}">+</a>
                                </div>
                            </li>
                            <li class="operate"><a href="${pageContext.request.contextPath}/cart/delete.do?productId=${cart.id}">删除</a></li>
                        </ul>
                    </c:forEach>
                </div>
            </div>
