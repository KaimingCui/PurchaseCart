...
<header class="header">
    <div class="logo"></div>
    <div class="nav">
        <a href="${pageContext.request.contextPath}/product/list.do" class="nav__item nav__course">课程</a>
    ...
    <form id="searchForm" method="post" action="${pageContext.request.contextPath}/product/list.do">
        <div class="search">
    ...
    <div class="container">
        ...
        <div class="course-list">
            <div align="right">
                ...
                <form method="post" action="${pageContext.request.contextPath}/product/list.do" style="display: inline">
                    <input type="hidden" name="page" value="1">
                ...
                <div class="course-card-container">
                    <div class="course-card">
                        ...
                        <div class="course-card-content">
                            <a href="${pageContext.request.contextPath}/detail/detail.do?productId=${product.id}">
